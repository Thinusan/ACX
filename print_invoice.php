...
<!--Header -->
<center><img src="print_image/invoice_header.jpg?<?php echo date("H:i:s"); ?>" width="100%"><hr/></center>
        <?php
...
<!-- footer -->
<div><br>
 <center><button type="button" name="printpagebutton" id="printpagebutton" class="btn btn-success" onclick="printpage()"><i class="fa fa-print"></i> Print Invoice</button></center> <!-- print button, but it was not visible in printed paper  -->
</div>
</body>
</html>
<?php
