...
<script type="text/javascript">
    function generate_repair_overall_report()
    {
        ...
        if(start_date!="" & end_date!="")
        {
            ...
            xmlhttp.onreadystatechange = function() 
            {
                ...
                {
                    document.getElementById("repair_overall_report").innerHTML=xmlhttp.responseText.trim();
                }
            };
            xmlhttp.open("GET", "ajaxreportpage.php?frompage=generate_repair_overall_report&ajax_start_date=" + start_date + "&ajax_end_date=" + end_date , true);
            xmlhttp.send();
        }
        else
        {
            document.getElementById("repair_overall_report").innerHTML='<div class="alert alert-danger" role="alert"><center><h3>- Startdate OR Enddate Fields Cannot be Empty ! -</h3></center></div>'; 
        }
    }
</script>
<!-- print overall repair report start-->
<script type="text/javascript">
    function repair_overall_report_print()
    {
        var start_date=document.getElementById("txt_start_date").value;
        var end_date=document.getElementById("txt_end_date").value;
        var url="print.php?print=repair_reports.php&option=repair_overall&print_start_date=" + start_date + "&print_end_date=" + end_date;
        if(start_date!="" & end_date!="" )
        {
...
<!-- print overall repair report end-->
<script type="text/javascript">
    function generate_repair_report_branchwise()
    {
        let start_date=document.getElementById("txt_start_date").value;
        let end_date=document.getElementById("txt_end_date").value;
        ...
        if(start_date!="" & end_date!="" & branchid!="")
        {
            ...
            xmlhttp.onreadystatechange = function() 
            {
                if (xmlhttp.readyState == 4 && xmlhttp.status == 200) 
                {
                    document.getElementById("repair_report_branchwise").innerHTML=xmlhttp.responseText.trim();
                }
            };
            xmlhttp.open("GET", "ajaxreportpage.php?frompage=generate_repair_report_branchwise&ajax_start_date=" + start_date + "&ajax_end_date=" + end_date + "&ajax_branchid=" + branchid , true);
            xmlhttp.send();
        }
        else
        {
            document.getElementById("repair_report_branchwise").innerHTML='<div class="alert alert-danger" role="alert"><center><h3>- Startdate or Enddate or Branch Fields Cannot be Empty ! -</h3></center></div>'; 
        }
    }
</script>
<!-- print repair report branchwise start-->
<script type="text/javascript">
    function repair_report_branchwise_print()
    {
        var start_date=document.getElementById("txt_start_date").value;
        var end_date=document.getElementById("txt_end_date").value;
        var branchid=document.getElementById("txt_branch").value;
        var url="print.php?print=repair_reports.php&option=repair_branchwise&print_start_date=" + start_date + "&print_end_date=" + end_date + "&print_branch_id=" + branchid;
        if(start_date!="" & end_date!="" & branchid!="" )
        {
            window.open(url,"_blank");
        }
...
<!-- print repair report branchwise end-->
<!-- repair reports end-->
<?php
if(isset($_GET["page"]))
{
...
{
    if($_GET["option"]=="repair_overall")
    {
        echo '<body onload="generate_repair_overall_report()">';
    }
    else if($_GET["option"]=="repair_branchwise")
    {
        echo '<body onload="generate_repair_report_branchwise()">';
    }
}
// option directory start

    if(isset($_GET["option"]))
        // overall repair report
    {    if($_GET["option"]=="repair_overall" & $system_user_type=="Manager")
        {
            ?>
            <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <center><h4 class="card-title">Overall repair Report</h4></center>
                                    ...
                                    <form method="POST" action="">
                                        <div class="form-row">                                                  
                                                ...
                                                <div class="form-group col-md-6" >
                                                    ...
                                                    ?>
                                                    <button type="button"  name="btn_generate_report" id="btn_generate_report" class="btn btn-primary" tabindex="2" onclick="generate_repair_overall_report()"> <i class="far fa-file-alt"></i> Generate Report</button>
                                                    <button type="button"  name="btn_print_report" id="btn_print_report" class="btn btn-success" tabindex="2" onclick="repair_overall_report_print()"> <i class="fa fa-print"></i> Print</button>
                                                    <?php
                                                    }
                                                    ?>
                                                </div>
                            ...
                            <div id="repair_overall_report"></div>
                        </div>
                    </div>
                </div>
            <?php
        }
        elseif($_GET["option"]=="repair_overall" & $system_user_type!="Manager")
        {
        ...
        elseif($_GET["option"]=="repair_branchwise")
        {
            ?>
            <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <center><h4 class="card-title">Branchwise Repair Report</h4></center>
                                <div class="basic-form">
                                    <form method="POST" action="">
                                        <div class="form-row col-md-12">                                                  
                                                ...
                                                <div class="form-group col-md-4" >
                                                    ...
                                                    ?>
                                                    <button type="button"  name="btn_generate_report" id="btn_generate_report" class="btn btn-primary" tabindex="2" onclick="generate_repair_report_branchwise()"> <i class="far fa-file-alt"></i> Generate Report</button>
                                                    <button type="button"  name="btn_print_report" id="btn_print_report" class="btn btn-success" tabindex="2" onclick="repair_report_branchwise_print()"> <i class="fa fa-print"></i> Print</button>
                                                    <?php
                                                    }
                                                    ?>
                                                </div>
                            ...
                            <div id="repair_report_branchwise"></div>
                        </div>
                    </div>
                </div>
            <?php
